local WOHotkeyConflict = {}

function WOHotkeyConflict.findConflict(key)
...
function WOHotkeyConflict.show(key, actionName, onKeep, onClear)
...
WorkOrders.KeyConflictDialog = WOHotkeyConflict
return WOHotkeyConflict
