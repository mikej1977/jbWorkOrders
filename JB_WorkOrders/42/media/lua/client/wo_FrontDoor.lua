...
local HUD_SIZE = 42
-- px of mosue slop before we know the player is REALLY dragging and not just caffeinated
...
-- puts it back where they left it, or somewhere close if the shit is offscreen
